            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="flex overflow-x-auto pb-8 gap-6 snap-x snap-mandatory scrollbar-hide -mx-4 px-4 lg:mx-0 lg:grid lg:grid-cols-5 lg:overflow-visible">
                    {cards.map((card, i) => (
                        ...
                        >
                            {/* Mock UI Element */}
                            <div className="absolute top-4 left-4 right-4 h-32 bg-slate-900/50 rounded-lg border border-white/5 backdrop-blur-sm group-hover:scale-105 transition-transform duration-500 flex items-center justify-center">
